...
ranking_uczelni_surowy <- c(301, 130, 237, 128, 571)
koszty_zycia_mies_eur <- c(2099.39, 2321.2, 1811.7, 1925.22, 1220.55)
odleglosc_od_macierzystej_km <- c(2125.79, 529.69, 2412.54, 1074.33, 1513.42)
stypendium_bazowe_eur <- c(670, 670, 670, 670, 600)
